...
function calculate_amounts(frm) {
    ...
    const taxes = frm.doc.tax_amount || 0;

    total_charge = charge+taxes;
    net_amount = outstanding - advance + total_charge;
        ...
        if (frm.doc.tax_template) {
            ...
            frappe.call({
                ...
                callback: function(r) {
                    ...
                    //***
                    //TAX CALCULATION BASED ON TOTAL RECEIVABLE AND PAYABLE
